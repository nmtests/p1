...
.table-auto tr:hover { background-color: #f8fafc; }
html.dark .table-auto tr:hover { background-color: #1e293b; }

/* --- Tabs --- */
.student-tab-button, .admin-tab-button {
...
.student-tab-button.active, .admin-tab-button.active {
    color: var(--accent);
...
.modal-backdrop { position: fixed; top: 0; left: 0; width: 100%; height: 100%; background-color: rgba(0,0,0,0.6); z-index: 40; display: flex; align-items: center; justify-content: center; padding: 1rem; }
...
@media (max-width: 768px) {
    ...
    .card { padding: 1rem; }
    .text-4xl.title-font { font-size: 2rem !important; }
}
